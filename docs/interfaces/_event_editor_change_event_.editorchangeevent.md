[antlr4-editor](../README.md) > ["event/editor-change-event"](../modules/_event_editor_change_event_.md) > [EditorChangeEvent](../interfaces/_event_editor_change_event_.editorchangeevent.md)
